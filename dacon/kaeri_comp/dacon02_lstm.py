...
dense1 = Dense(16, activation='relu')(dropout1)
...
lstm3 = LSTM(8, activation='relu')(input3)
dropout3 = Dropout(rate=0.2)(lstm3)
dense3 = Dense(16, activation='relu')(dropout3)

input4 = Input(shape=(375,1))
lstm4 = LSTM(8, activation='relu')(input4)
dropout4 = Dropout(rate=0.2)(lstm4)
dense4 = Dense(16, activation='relu')(dropout4)
...
model.fit([x_train_s1, x_train_s2, x_train_s3, x_train_s4], 
         ...
         batch_size=128, epochs=20, verbose=1, validation_split=0.15)
...
y_pred.to_csv('./data/dacon//kaeri_comp/sample_submission_kaeri_lstm.csv',
              header=['X','Y','M','V'],
              index=True,
              index_label='id')

...
X_data = np.loadtxt('D:/Study/data/dacon/kaeri_comp/train_features.csv',skiprows=1,delimiter=',')
X_data = X_data[:,1:]
print(X_data.shape)
     
    
Y_data = np.loadtxt('D:/Study/data/dacon/kaeri_comp/train_target.csv',skiprows=1,delimiter=',')
Y_data = Y_data[:,1:]
print(Y_data.shape)
...
X_data_test = np.loadtxt('D:/Study/data/dacon/kaeri_comp/test_features.csv',skiprows=1,delimiter=',')
...
def train(model,X,Y):
    MODEL_SAVE_FOLDER_PATH = 'D:/Study/data/dacon/kaeri_comp/model/'
...
submit = pd.read_csv('D:/Study/data/dacon/kaeri_comp/sample_submission.csv')
...
submit.to_csv('D:/Study/data/dacon/kaeri_comp/output_submit.csv', index = False)
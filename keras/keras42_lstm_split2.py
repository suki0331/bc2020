...
data_split = split_data(a,size)   # (96,5)
...
x_train, x_test, y_train, y_test = train_test_split(data_split_x, data_split_y,
                                                    train_size = 0.8)       


# practice 3. make validation set (20% of train set)
input1 = Input(shape=(4,))
dense_1 = Dense(64, activation='relu')(input1)
output1 = Dense(1)(dense_1)
...
early_stopping = EarlyStopping(monitor='val_loss', patience = 15, mode = 'auto', verbose = 1)

model_1.fit(data_split_x, data_split_y, batch_size=1, validation_split=0.2,
            epochs=200, verbose =2, callbacks=[early_stopping])
model_1.summary()

...
x_train = x_train.reshape(50000, 3, 32*32)/255.0
x_test = x_test.reshape(10000, 3, 32*32)/255.0
...
layer3 = LSTM(32, activation='relu', return_sequences=True)(layer2)
layer4 = Dropout(rate=0.2)(layer3)
layer5 = LSTM(64, activation='relu')(layer4)
...
model_filepath = './model/keras72_model/{epoch:02d}-{val_loss:04f}-{acc:04f}.hdf5'
model_checkpoint = ModelCheckpoint(filepath=model_filepath, monitor='val_loss', verbose=1, save_best_only=True)
tb_hist = TensorBoard(log_dir='graph_keras72', histogram_freq=0,

...
# pca  
# pca = PCA(4)
# x_hit = pca.fit_transform(x_hit)


x_hit = x_hit.reshape(-1, x_hit.shape[1], 1)
# x_sam = x_sam.reshape(-1, x_sam.shape[1], 1)
...
x2 = LSTM(32, activation='relu')(input2)
...
model.fit([x_sam, x_hit], y_sam, epochs=80)    